...
fname <- paste0(figdir, "maintextfigure4.pdf")
setwd(basedir)
...
layout(matrix(1:6, nrow = 2, ncol = 3), widths = c(1.1, rep(1.0, 2)), heights = rep(c(0.98, 1.0), 6))
...
EBTdt       <- read.table(paste0(datadir, "Ecobif-RS000-WSup.minmax.out"))
...
EBTdt       <- read.table(paste0(datadir, "Ecobif-RS000-WSdwn.minmax.out"))
EBTmax      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)),]
EBTmin      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)) - 1,]
...
mtext("A: no reserve", 3, cex = cexttl, line = 1.0)
...
legend("topleft", c("Stable equilibrium", "Unstable equilibrium", "Cycle minimum / maximum"), col = "black", lwd = c(2, 1, 1, 1) * baselwd, cex = cexleg, lty = c(1, unstablelty, 1))
...
legend("topleft", c("Harvested area", "Marine reserve"), col = c("#0072B2", "#D55E00"), lwd = baselwd, cex = cexleg)
...
EBTdt       <- read.table(paste0(datadir, "Ecobif-RS010-WSup.minmax.out"))
EBTmax      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)),]
EBTmin      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)) - 1,]
...
EBTdt       <- read.table(paste0(datadir, "Ecobif-RS010-WSdwn.minmax.out"))
EBTmax      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)),]
EBTmin      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)) - 1,]
...
mtext("B: 10% protected", 3, cex = cexttl, line = 1.0)
# text(xlim1[2], ylimb[2], "A", cex = 4.0, xpd = T, adj = c(0.5, 0))
...
lines(dt[(1:indx1),PSPMbifparcol], dt[(1:indx1),PSPMh1biocol], lwd = 2 * baselwd, col = "black")
lines(dt[(indx1:indx2),PSPMbifparcol], dt[(indx1:indx2),PSPMh1biocol], lwd = baselwd, lty = unstablelty, col = "black")
lines(dt[(indx2:indx3),PSPMbifparcol], dt[(indx2:indx3),PSPMh1biocol], lwd = 2 * baselwd, col = "black")
lines(dt[(indx3:nrow(dt)),PSPMbifparcol], dt[(indx3:nrow(dt)),PSPMh1biocol], lwd = baselwd, col = "black", lty = unstablelty)
...
lines(dt[(1:indx1),PSPMbifparcol], dt[(1:indx1),PSPMh2juvbiocol] + dt[(1:indx1),PSPMh2adubiocol], lwd = 2 * baselwd, col = "#0072B2")
lines(dt[(indx1:indx2),PSPMbifparcol], dt[(indx1:indx2),PSPMh2juvbiocol] + dt[(indx1:indx2),PSPMh2adubiocol], lwd = baselwd, lty = unstablelty, col = "#0072B2")
lines(dt[(indx2:indx3),PSPMbifparcol], dt[(indx2:indx3),PSPMh2juvbiocol] + dt[(indx2:indx3),PSPMh2adubiocol], lwd = 2 * baselwd, col = "#0072B2")
lines(dt[(indx3:nrow(dt)),PSPMbifparcol], dt[(indx3:nrow(dt)),PSPMh2juvbiocol] + dt[(indx3:nrow(dt)),PSPMh2adubiocol], lwd = baselwd, col = "#0072B2", lty = unstablelty)

lines(dt[(1:indx1),PSPMbifparcol], dt[(1:indx1),PSPMh3juvbiocol] + dt[(1:indx1),PSPMh3adubiocol], lwd = 2 * baselwd, col = "#D55E00")
lines(dt[(indx1:indx2),PSPMbifparcol], dt[(indx1:indx2),PSPMh3juvbiocol] + dt[(indx1:indx2),PSPMh3adubiocol], lwd = baselwd, lty = unstablelty, col = "#D55E00")
lines(dt[(indx2:indx3),PSPMbifparcol], dt[(indx2:indx3),PSPMh3juvbiocol] + dt[(indx2:indx3),PSPMh3adubiocol], lwd = 2 * baselwd, col = "#D55E00")
lines(dt[(indx3:nrow(dt)),PSPMbifparcol], dt[(indx3:nrow(dt)),PSPMh3juvbiocol] + dt[(indx3:nrow(dt)),PSPMh3adubiocol], lwd = baselwd, col = "#D55E00", lty = unstablelty)
...
EBTdt       <- read.table(paste0(datadir, "Ecobif-RS030-WSup.minmax.out"))
EBTmax      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)),]
EBTmin      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)) - 1,]
...
EBTdt       <- read.table(paste0(datadir, "Ecobif-RS030-WSdwn.minmax.out"))
EBTmax      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)),]
EBTmin      <- EBTdt[2 * (1:(nrow(EBTdt) / 2.0)) - 1,]
...
axis(1, label = F, cex.axis = cexaxs, lwd = 0, lwd.ticks = axislwd)
axis(2, label = F, cex.axis = cexaxs, lwd = 0, lwd.ticks = axislwd, las = 2)
mtext("C: 30% protected", 3, cex = cexttl, line = 1.0)
# text(xlim1[2], ylimb[2], "A", cex = 4.0, xpd = T, adj = c(0.5, 0))
...
lines(EBTdwnM[,EBTbifparcol], EBTdwnM[,EBTh1biocol], lwd = baselwd, col = "black")
...
lines(EBTdwnM[,EBTbifparcol], EBTdwnM[,EBTh2biocol], lwd = baselwd, col = "#0072B2")
lines(EBTdwnM[,EBTbifparcol], EBTdwnM[,EBTh3biocol], lwd = baselwd, col = "#D55E00")
