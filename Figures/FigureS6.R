...
fname <- paste0(figdir, "appendixFigS6.pdf")
setwd(basedir)
...
zlabs   <- (0:5) * 0.1
zconts  <- seq(0, 0.4, length.out = 10)
zclrs   <- seq(0, 0.4, length.out = 200)
selectedcol <- EBTh2biocol
...
mtext("Average yield of total biomass per unit time", 3, cex = cexttl, line = 5.0)
