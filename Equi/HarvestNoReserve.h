/*
  HarvestNoReserverve.h -  Header file specifying the elementary life-history functions of
                ...
                Non-breeding habitat consists of a harvested habitat only
  ...
  Last modification: AMdR - Jun 12, 2022
*/
...
void EnvEqui(double E[], double I[POPULATION_NR][INTERACT_DIM], double condition[ENVIRON_DIM])
{
  ...
  condition[1] = (RHO1 - DELTA * F2) - Q * F2 * I[0][9];
